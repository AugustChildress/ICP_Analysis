...
'''
'''
The values above are values used to equate color filters to a tempurature using the equation 10,000K/T = K(B-V)+C.
...
opposed to the C = 0.72 from this program based on the data provided by Cietti et al. These values are only B-V color tempurature. They must
